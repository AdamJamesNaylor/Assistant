namespace Imbick.Assistant.Core {
    ...
    ///    <br/>
    ///    <b>Example</b><br/>
    ///    From: <c>Content-Disposition attachment; filename="specialChars∆ÿ≈"</c><br/>
    ...
    ///    <br/>
    ///    <b>Example</b><br/>
    ///    From: <c>Content-Disposition attachment; filename="specialChars∆ÿ≈WhichIsSoLong"</c><br/>
    ...
    internal static class Rfc2231Decoder
    {
        ...
        public static List<KeyValuePair<string, string>> Decode(string toDecode)
        {
            ...
            List<string> splitted = toDecode.Trim().SplitStringWithCharNotInsideQuotes(';');
        ...
        private static List<KeyValuePair<string, string>> DecodePairs(List<KeyValuePair<string, string>> pairs)
        {
            ...
            for (int i = 0; i < pairsCount; i++)
            {
                ...
                string value = currentPair.Value.RemoveQuotesIfAny();
                ...
                if (key.EndsWith("*0", StringComparison.OrdinalIgnoreCase) || key.EndsWith("*0*", StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    for (int j = i + 1, continuationCount = 1; j < pairsCount; j++, continuationCount++)
                    {
                        ...
                        string valueJKey = pairs[j].Value.RemoveQuotesIfAny();
