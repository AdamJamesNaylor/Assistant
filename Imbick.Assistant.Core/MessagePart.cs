namespace Imbick.Assistant.Core {
    ...
    public class MessagePart {
        ...
        /// to the default of <see cref="Core.Encoding.ContentTransferEncoding.SevenBit">SevenBit</see> in accordance to the RFC.
        /// </summary>
        ...
        internal MessagePart(byte[] rawBody, MessageHeader headers) {
            ...
            /*}
                ...
                if (_parsingErrorHandler != null) {
                    _parsingErrorHandler.HandleParseError(new ParseError(ex, ContentType.CharSet,
                        string.Format("On body encoding. Encoding set to {0}", BodyEncoding.EncodingName)));
                }
                else {
                    throw;
                }
        ...
        private static List<byte[]> GetMultiPartParts(byte[] rawBody, string multipPartBoundary) {
            ...
            using (MemoryStream stream = new MemoryStream(rawBody)) {
                ...
                int startLocation =
                    FindPositionOfNextMultiPartBoundary(stream, multipPartBoundary, out lastMultipartBoundaryEncountered) +
                    ("--" + multipPartBoundary + "\r\n").Length;
                while (true) {
                    ...
                    int stopLocation =
                        FindPositionOfNextMultiPartBoundary(stream, multipPartBoundary,
        ...
        private static int FindPositionOfNextMultiPartBoundary(Stream stream, string multiPartBoundary,
            ...
            while (true) {
                ...
                // Read the line
                string line = stream.ReadLineAsAscii();
