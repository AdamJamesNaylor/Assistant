namespace Imbick.Assistant.Core.Encoding {
    using System;
    ...
    public static class EncodingFinder
    {
        ...
        internal static void Reset()
        {
            ...
            AddMapping("binary", System.Text.Encoding.ASCII);
        }
        ...
        internal static System.Text.Encoding FindEncoding(string characterSet)
        {
            ...
            try
            {
                ...
                {
                    return System.Text.Encoding.GetEncoding("iso-" + characterSet.Substring(3));
                }
