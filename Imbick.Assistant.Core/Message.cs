namespace Imbick.Assistant.Core {
    ...
    /// <see cref="Core.MessagePart"/> for a description about the structure.<br/>
    /// <br/>
    ...
    public class Message {
        ...
        /// <summary>
        /// Convenience constructor for <see cref="Message"/>.<br/>
        /// <br/>
        ...
        public MailMessage ToMailMessage() {
            ...
            foreach (MessagePart attachmentMessagePart in attachments) {
                ...
                attachment.Name = String.IsNullOrEmpty(attachment.Name)
        ...
        /// <br/>
        /// <see cref="Core.MessagePart.IsText"/> for MessageParts which are considered to be text versions.<br/>
        /// <br/>
        ...
        /// <br/>
        /// <see cref="Core.MessagePart.IsAttachment"/> for MessageParts which are considered to be attachments.
        /// </summary>
